...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen flex justify-center items-center p-4 text-center text-white font-bold'>
        <form action="https://getform.io/f/ed9238bc-40f2-48f8-a020-e0559e3b3b30" method='POST' className='flex flex-col max-w-[600px] w-full'>
            ...
            <input className='bg-gray-200 p-2 my-4 text-black' type="email" name='email' placeholder='Email'/>
            <textarea className='bg-gray-200 p-2 text-black' name="message"  rows="10" placeholder='Message'></textarea>
